...
const EventCardDekstopLoadingComp = () => {
	return (
		<div className={`col-3  m-0 p-0 ${styles.cardDiv}`}>
			<div className={` ${styles.loadingCard}`}>
				...
				<div className={` ${styles.dateNiconsDiv}`}>
					...
					<div className={` ${styles.statusIconsDiv}`}>
						<Skeleton
							className={` ${styles.singleStatusIcon} `}
							style={{ background: '#232327' }}
							variant='circle'
							width={25}
							height={25}
...
export default EventCardDekstopLoadingComp;
