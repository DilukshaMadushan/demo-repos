  ...
  render() {
    return (
      <div className="container-fluid cookies">
          <h1>Cookie Policy for kiyanna.world</h1>

        <p>This is the Cookie Policy for kiyanna.world, accessible from http://kiyanna.world</p>
        ...
        <ul>
        <li>Email: admin@kiyanna.world</li>
